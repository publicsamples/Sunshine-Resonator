...
template <int NV> using comp_mod_2 = xfader1_c0<NV>;
...
template <int NV> struct instance: public ResStage_impl::ResStage_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(996)
		{
            ...
            0x4166, 0x0000, 0x0000, 0x0000, 0x8000, 0x513F, 0x17C7, 0xB53D, 
            0x74D7, 0x003E, 0x0000, 0x5B00, 0x0002, 0x0000, 0x7543, 0x4F74, 
            0x6666, 0x0042, 0x0000, 0x0000, 0x0000, 0x3F80, 0xF2AD, 0x3F73, 
            ...
            0x6572, 0x6873, 0x0000, 0xC800, 0x00C2, 0x0000, 0x9900, 0xC599, 
            ...
            0x6D6F, 0x5270, 0x6C65, 0x0000, 0x8000, 0x003F, 0x0000, 0x9A42, 
            0x7199, 0xA341, 0xDC81, 0xCD3E, 0xCCCC, 0x5B3D, 0x0008, 0x0000, 
            0x6F43, 0x706D, 0x6152, 0x6974, 0x006F, 0x0000, 0x0000, 0x0000, 
            0x437A, 0x6667, 0x429E, 0x81A3, 0x3EDC, 0xCCCD, 0x3DCC, 0x095B, 
            ...
            0x0000, 0x3F80, 0x642D, 0x3ED8, 0x0000, 0x3F80, 0x0000, 0x0000, 
            ...
            0x0071, 0x0000, 0x0000, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x0000, 
            0x3F80, 0x0000, 0x0000, 0x0F5B, 0x0000, 0x5200, 0x7365, 0x694D, 
            0x006E, 0x0000, 0x435C, 0x0000, 0x455C, 0x0000, 0x435C, 0x6C1A, 
            0x3E6B, 0x0000, 0x0000, 0x105B, 0x0000, 0x5200, 0x7365, 0x614D, 
            0x0078, 0x0000, 0x435C, 0x0000, 0x455C, 0x0000, 0x455C, 0x6C1A, 
            0x3E6B, 0x0000, 0x0000, 0x115B, 0x0000, 0x5200, 0x7365, 0x7453, 
            0x7065, 0x0000, 0x0000, 0x0000, 0x8000, 0x0043, 0x0000, 0x0000, 
            0x8000, 0x003F, 0x0000, 0x5B00, 0x0012, 0x0000, 0x6552, 0x4D73, 
            0x646F, 0x0065, 0x0000, 0x3F80, 0x0000, 0x40A0, 0x0000, 0x3F80, 
            ...
            0x0000, 0x3F80, 0x999A, 0x3DA2, 0x0000, 0x3F80, 0x0000, 0x0000, 
            ...
            0x593F, 0x80C8, 0x003E, 0x8000, 0x003F, 0x0000, 0x5B00, 0x001F, 
            ...
            0x0000, 0x0000, 0x0000, 0x8000, 0x593F, 0x43C8, 0x003F, 0x8000, 
            ...
            0x6C65, 0x0032, 0x0000, 0x3F80, 0x0000, 0x4200, 0x0000, 0x3F80, 
            0x0000, 0x3F80, 0x0000, 0x0000, 0x305B, 0x0000, 0x4300, 0x6D70, 
            0x6552, 0x336C, 0x0000, 0x8000, 0x003F, 0x0000, 0x0042, 0x8000, 
            0x003F, 0x8000, 0x003F, 0x0000, 0x5B00, 0x0031, 0x0000, 0x6F43, 
            ...
            0x6600, 0x6E69, 0x0065, 0x0000, 0x0000, 0x0000, 0x3F80, 0x37A7, 
            0x3EFF, 0x0000, 0x3F80, 0x0000, 0x0000, 0x375B, 0x0000, 0x7300, 
            0x6163, 0x656C, 0x0000, 0x8000, 0x003F, 0xE000, 0x0040, 0x4000, 
            0x0040, 0x8000, 0x003F, 0x8000, 0x5B3F, 0x0038, 0x0000, 0x6153, 
	...
	instance()
	{
		...
		auto& split = this->getT(2);                                              // ResStage_impl::split_t<NV>
		auto& chain9 = this->getT(2).getT(0);                                     // ResStage_impl::chain9_t
		auto& chain14 = this->getT(2).getT(1);                                    // ResStage_impl::chain14_t<NV>
		auto& comp = this->getT(2).getT(1).getT(0);                               // ResStage_impl::comp_t<NV>
		auto& clear5 = this->getT(2).getT(1).getT(1);                             // math::clear<NV>
		auto& split5 = this->getT(3);                                             // ResStage_impl::split5_t<NV>
		auto& chain11 = this->getT(3).getT(0);                                    // ResStage_impl::chain11_t<NV>
		auto& gain = this->getT(3).getT(0).getT(0);                               // core::gain<NV>
		auto& chain12 = this->getT(3).getT(1);                                    // ResStage_impl::chain12_t<NV>
		auto& chain21 = this->getT(3).getT(1).getT(0);                            // ResStage_impl::chain21_t<NV>
		auto& chain13 = this->getT(3).getT(1).getT(0).getT(0);                    // ResStage_impl::chain13_t<NV>
		auto& clear4 = this->getT(3).getT(1).getT(0).getT(0).getT(0);             // math::clear<NV>
		auto& oscillator = this->getT(3).getT(1).getT(0).getT(0).getT(1);         // ResStage_impl::oscillator_t<NV>
		auto& gain1 = this->getT(3).getT(1).getT(0).getT(0).getT(2);              // core::gain<NV>
		auto& pi = this->getT(3).getT(1).getT(0).getT(0).getT(3);                 // math::pi<NV>
		auto& tanh1 = this->getT(3).getT(1).getT(0).getT(0).getT(4);              // wrap::no_process<math::tanh<NV>>
		auto& one_pole1 = this->getT(3).getT(1).getT(0).getT(0).getT(5);          // wrap::no_process<filters::one_pole<NV>>
		auto& peak10 = this->getT(3).getT(1).getT(0).getT(0).getT(6);             // ResStage_impl::peak10_t
		auto& gain76 = this->getT(3).getT(1).getT(0).getT(0).getT(7);             // core::gain<NV>
		auto& clear2 = this->getT(3).getT(1).getT(1);                             // wrap::no_process<math::clear<NV>>
		auto& tempo_sync1 = this->getT(4);                                        // ResStage_impl::tempo_sync1_t<NV>
		auto& chain6 = this->getT(5);                                             // ResStage_impl::chain6_t<NV>
		auto& gain5 = this->getT(5).getT(0);                                      // core::gain<NV>
		auto& one_pole30 = this->getT(5).getT(1);                                 // filters::one_pole<NV>
		auto& minmax = this->getT(5).getT(2);                                     // ResStage_impl::minmax_t<NV>
		auto& receive58 = this->getT(5).getT(3);                                  // routing::receive<stereo_cable>
		auto& faust = this->getT(5).getT(4);                                      // project::PitchShifter<NV>
		auto& send = this->getT(5).getT(5);                                       // routing::send<stereo_cable>
		auto& modchain = this->getT(5).getT(6);                                   // ResStage_impl::modchain_t<NV>
		auto& Pitch = this->getT(5).getT(6).getT(0);                              // ResStage_impl::Pitch_t<NV>
		auto& chain3 = this->getT(5).getT(6).getT(0).getT(0);                     // ResStage_impl::chain3_t<NV>
		auto& minmax3 = this->getT(5).getT(6).getT(0).getT(0).getT(0);            // ResStage_impl::minmax3_t<NV>
		auto& converter1 = this->getT(5).getT(6).getT(0).getT(0).getT(1);         // ResStage_impl::converter1_t<NV>
		auto& clear = this->getT(5).getT(6).getT(0).getT(0).getT(2);              // math::clear<NV>
		auto& clear1 = this->getT(5).getT(6).getT(1);                             // math::clear<NV>
		auto& add7 = this->getT(5).getT(6).getT(2);                               // math::add<NV>
		auto& pi3 = this->getT(5).getT(6).getT(3);                                // math::pi<NV>
		auto& peak3 = this->getT(5).getT(6).getT(4);                              // ResStage_impl::peak3_t<NV>
		auto& clear3 = this->getT(5).getT(6).getT(5);                             // math::clear<NV>
		auto& peak9 = this->getT(6);                                              // ResStage_impl::peak9_t
		auto& FilterForRes1 = this->getT(7);                                      // project::FilterForRes<NV>
		auto& pma10 = this->getT(8);                                              // ResStage_impl::pma10_t<NV>
		auto& oscilloscope = this->getT(9);                                       // ResStage_impl::oscilloscope_t
		...
		auto& one_pole4 = this->getT(10).getT(0).getT(1);                         // filters::one_pole<NV>
		auto& one_pole3 = this->getT(10).getT(0).getT(2);                         // filters::one_pole<NV>
		auto& gain3 = this->getT(10).getT(0).getT(3);                             // wrap::no_process<core::gain<NV>>
		...
		auto& tanh2 = this->getT(11);                                             // math::tanh<NV>
		auto& FilterForRes = this->getT(12);                                      // project::FilterForRes<NV>
		...
		this->getParameterT(8).connectT(0, comp); // CompRatio -> comp::Release
		...
		this->getParameterT(14).connectT(0, minmax3); // ResFreq -> minmax3::Value
		
		this->getParameterT(15).connectT(0, minmax3); // ResMin -> minmax3::Minimum
		
		this->getParameterT(16).connectT(0, minmax3); // ResMax -> minmax3::Maximum
		
		this->getParameterT(17).connectT(0, minmax3); // ResStep -> minmax3::Step
		...
		converter1.getWrappedObject().getParameter().connectT(0, Filetrig1); // converter1 -> Filetrig1::MS
		converter1.getWrappedObject().getParameter().connectT(1, Filetrig3); // converter1 -> Filetrig3::MS
		converter1.getWrappedObject().getParameter().connectT(2, Filetrig4); // converter1 -> Filetrig4::MS
		converter1.getWrappedObject().getParameter().connectT(3, Filetrig5); // converter1 -> Filetrig5::MS
		converter1.getWrappedObject().getParameter().connectT(4, res3);      // converter1 -> res3::Del
		converter1.getWrappedObject().getParameter().connectT(5, res4);      // converter1 -> res4::Del
		converter1.getWrappedObject().getParameter().connectT(6, res5);      // converter1 -> res5::Del
		...
		minmax3.getWrappedObject().getParameter().connectT(6, converter1);   // minmax3 -> converter1::Value
		...
		oscillator.setParameterT(1, 1217.5); // core::oscillator::Frequency
		...
		pi.setParameterT(0, 0.999144); // math::pi::Value
		...
		minmax3.setParameterT(3, 0.223231); // control::minmax::Skew
		...
		one_pole4.setParameterT(0, 68.241); // filters::one_pole::Frequency
		...
		res3.setParameterT(8, -1.4);  // project::res1::ga
		...
		res5.setParameterT(8, -11.);     // project::res1::ga
		...
		tanh2.setParameterT(0, 0.697511); // math::tanh::Value
		...
		this->setParameterT(1, 0.0370553);
		this->setParameterT(2, 0.952922);
		this->setParameterT(3, 0.);
		this->setParameterT(4, 1.);
		this->setParameterT(5, -24.);
		this->setParameterT(6, 0.);
		this->setParameterT(7, 15.1);
		this->setParameterT(8, 79.2);
		this->setParameterT(9, 0.);
		this->setParameterT(10, 20.);
		this->setParameterT(11, 0.422639);
		this->setParameterT(12, 7.);
		this->setParameterT(13, 31.);
		this->setParameterT(14, 1.);
		this->setParameterT(15, 220.);
		this->setParameterT(16, 3520.);
		...
		this->setParameterT(54, 0.498471);
		this->setParameterT(55, 3.);
	...
	void setExternalData(const ExternalData& b, int index)
	{
		...
		this->getT(3).getT(1).getT(0).getT(0).getT(1).setExternalData(b, index); // ResStage_impl::oscillator_t<NV>
		this->getT(3).getT(1).getT(0).getT(0).getT(6).setExternalData(b, index); // ResStage_impl::peak10_t
		this->getT(5).getT(6).getT(4).setExternalData(b, index);                 // ResStage_impl::peak3_t<NV>
		this->getT(6).setExternalData(b, index);                                 // ResStage_impl::peak9_t
		this->getT(9).setExternalData(b, index);                                 // ResStage_impl::oscilloscope_t
