...
struct _klp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = 1.0f - fSlow1 * (fTemp0 * (1.0f - fTemp3) / fTemp2);
			float fTemp6 = fTemp0 * ((fRec3[1] - (fRec2[1] - (fTemp1 - fSlow1 * fRec1[1] * fTemp4)) / fTemp2) / fTemp5 - fRec1[1]) / fTemp2;
			...
			float fTemp9 = fTemp0 * ((fRec8[1] - (fRec7[1] - (fTemp8 - fSlow1 * fTemp4 * fRec6[1])) / fTemp2) / fTemp5 - fRec6[1]) / fTemp2;
