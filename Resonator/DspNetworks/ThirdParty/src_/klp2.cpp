...
struct _klp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = 2.0f * fTemp5 + fRec0[1];
			fRec1[0] = 2.0f * (fTemp1 / fTemp2) + fRec1[1];
			float fTemp6 = fTemp5 + fRec0[1];
			fRec2[0] = 2.0f * ((fSlow1 * fTemp6 - fRec2[1]) * fTemp0 / fTemp2) + fRec2[1];
			float fRec3 = fTemp6;
			output0[i0] = FAUSTFLOAT(fRec3);
			float fTemp7 = (float(input1[i0]) - fRec6[1]) * fTemp0;
			float fTemp8 = ((fRec6[1] + (fTemp7 + fSlow1 * fRec5[1] * fTemp3 - fRec7[1]) / fTemp2) / fTemp4 - fRec5[1]) * fTemp0 / fTemp2;
			fRec5[0] = fRec5[1] + 2.0f * fTemp8;
			fRec6[0] = fRec6[1] + 2.0f * (fTemp7 / fTemp2);
			float fTemp9 = fRec5[1] + fTemp8;
			fRec7[0] = fRec7[1] + 2.0f * ((fSlow1 * fTemp9 - fRec7[1]) * fTemp0 / fTemp2);
			float fRec8 = fTemp9;
