...
struct _ObLfp final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = std::max<float>(-1.0f, std::min<float>(1.0f, fTemp4 + fRec1[1]));
			float fTemp6 = fTemp5 * (1.0f - 0.33333334f * _ObLfp_faustpower2_f(fTemp5));
			float fTemp7 = fTemp6 * fTemp0;
			fRec0[0] = 2.0f * fTemp7 + fRec0[1];
			fRec1[0] = fTemp4 + fTemp6;
			float fTemp8 = fTemp7 + fRec0[1];
			float fRec2 = fTemp8;
