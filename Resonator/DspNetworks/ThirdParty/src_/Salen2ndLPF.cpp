...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _Salen2ndLPF -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___Salen2ndLPF_H__
#define  ___Salen2ndLPF_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _Salen2ndLPF
#endif
...
struct _Salen2ndLPF final : public ::faust::dsp {
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _Salen2ndLPF -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "Salen2ndLPF.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.8.0");
		m->declare("name", "Salen2ndLPF");
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Salen2ndLPF");
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = float(input0[i0]) - (fTemp1 * fRec2[1] + fRec1[1]);
			float fTemp3 = fTemp1 * fTemp0 + 1.0f;
			float fTemp4 = fTemp2 * fTemp0 / fTemp3;
			float fTemp5 = 2.0f * fTemp4 + fRec2[1];
			float fRec0 = fTemp5 * fTemp0 + fRec1[1];
			float fTemp6 = fTemp4 + fRec2[1];
			fRec1[0] = 2.0f * fTemp6 * fTemp0 + fRec1[1];
			fRec2[0] = fTemp5;
	...
	#define FAUST_FILE_NAME "Salen2ndLPF.dsp"
	#define FAUST_CLASS_NAME "_Salen2ndLPF"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _Salen2ndLPF -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
