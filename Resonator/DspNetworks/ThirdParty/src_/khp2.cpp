...
struct _khp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec1[0] = 2.0f * ((fTemp6 - (fRec1[1] + fRec2[1] + fTemp7)) * fTemp1 / fTemp3) + fRec1[1];
			fRec2[0] = 2.0f * fTemp7 + fRec2[1];
			fRec3[0] = 2.0f * (fTemp2 / fTemp3) + fRec3[1];
			output0[i0] = FAUSTFLOAT(fRec0);
			float fTemp8 = float(input1[i0]);
			float fTemp9 = (fTemp8 - fRec8[1]) * fTemp1;
			float fTemp10 = (fTemp8 - (fRec8[1] + (fTemp9 - fRec6[1] + fRec7[1] * fTemp1 / fTemp3) / fTemp3)) / fTemp4;
			float fRec5 = fTemp10;
			float fTemp11 = fSlow1 * fTemp10;
			float fTemp12 = (fTemp11 - fRec7[1]) * fTemp1 / fTemp3;
			fRec6[0] = fRec6[1] + 2.0f * ((fTemp11 - (fTemp12 + fRec6[1] + fRec7[1])) * fTemp1 / fTemp3);
