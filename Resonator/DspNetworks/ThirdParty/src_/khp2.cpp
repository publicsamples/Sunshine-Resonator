...
struct _khp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = (fTemp1 - fRec2[1]) * fTemp0;
			float fTemp3 = fTemp0 + 1.0f;
			float fTemp4 = 1.0f - fSlow1 * (fTemp0 * (1.0f - fTemp0 / fTemp3) / fTemp3);
			float fTemp5 = (fTemp1 - (fRec2[1] + (fTemp2 - fRec0[1] + fTemp0 * fRec1[1] / fTemp3) / fTemp3)) / fTemp4;
			float fTemp6 = fSlow1 * fTemp5;
			float fTemp7 = fTemp0 * (fTemp6 - fRec1[1]) / fTemp3;
			fRec0[0] = fRec0[1] + 2.0f * (fTemp0 * (fTemp6 - (fTemp7 + fRec0[1] + fRec1[1])) / fTemp3);
			fRec1[0] = fRec1[1] + 2.0f * fTemp7;
			fRec2[0] = fRec2[1] + 2.0f * (fTemp2 / fTemp3);
			float fRec3 = fTemp5;
			output0[i0] = FAUSTFLOAT(fRec3);
			float fTemp8 = float(input1[i0]);
			float fTemp9 = fTemp0 * (fTemp8 - fRec7[1]);
			float fTemp10 = (fTemp8 - (fRec7[1] + (fTemp9 - fRec5[1] + fTemp0 * fRec6[1] / fTemp3) / fTemp3)) / fTemp4;
			float fTemp11 = fSlow1 * fTemp10;
			float fTemp12 = fTemp0 * (fTemp11 - fRec6[1]) / fTemp3;
			fRec5[0] = fRec5[1] + 2.0f * (fTemp0 * (fTemp11 - (fTemp12 + fRec5[1] + fRec6[1])) / fTemp3);
			fRec6[0] = fRec6[1] + 2.0f * fTemp12;
			fRec7[0] = fRec7[1] + 2.0f * (fTemp9 / fTemp3);
			float fRec8 = fTemp10;
