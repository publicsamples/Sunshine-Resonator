...
struct _gran final : public ::faust::dsp {
	...
	void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("taille", &fHslider2, FAUSTFLOAT(1e+02f), FAUSTFLOAT(4.0f), FAUSTFLOAT(2e+02f), FAUSTFLOAT(0.001f));
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = std::max<float>(4.0f, std::min<float>(2e+02f, float(fHslider2)));
	...
	FAUST_ADDHORIZONTALSLIDER("taille", fHslider2, 1e+02f, 4.0f, 2e+02f, 0.001f);
	...
	#define FAUST_LIST_ACTIVES(p) \
		...
		p(HORIZONTALSLIDER, taille, "taille", fHslider2, 1e+02f, 4.0f, 2e+02f, 0.001f) \
