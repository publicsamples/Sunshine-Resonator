...
Compilation options: -lang cpp -rui -nvi -ct 1 -cn _Salen2ndBPF -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0
------------------------------------------------------------ */

#ifndef  ___Salen2ndBPF_H__
#define  ___Salen2ndBPF_H__
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS _Salen2ndBPF
#endif
...
struct _Salen2ndBPF final : public ::faust::dsp {
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-lang cpp -rui -nvi -ct 1 -cn _Salen2ndBPF -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0");
		m->declare("filename", "Salen2ndBPF.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.8.0");
		m->declare("name", "Salen2ndBPF");
	...
	void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Salen2ndBPF");
	...
	#define FAUST_FILE_NAME "Salen2ndBPF.dsp"
	#define FAUST_CLASS_NAME "_Salen2ndBPF"
	#define FAUST_COMPILATION_OPIONS "-lang cpp -rui -nvi -ct 1 -cn _Salen2ndBPF -scn ::faust::dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -uim -single -ftz 0"
