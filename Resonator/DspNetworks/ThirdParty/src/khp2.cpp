...
struct _khp2 final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp9 = (fTemp8 - fRec7[1]) * fTemp0;
			float fTemp10 = (fTemp8 - (fRec7[1] + (fTemp9 - fRec5[1] + fRec6[1] * fTemp0 / fTemp3) / fTemp3)) / fTemp4;
			float fTemp11 = fSlow1 * fTemp10;
			float fTemp12 = (fTemp11 - fRec6[1]) * fTemp0 / fTemp3;
			fRec5[0] = fRec5[1] + 2.0f * ((fTemp11 - (fTemp12 + fRec5[1] + fRec6[1])) * fTemp0 / fTemp3);
