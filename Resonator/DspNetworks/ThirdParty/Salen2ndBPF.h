...
#include "src/Salen2ndBPF.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct Salen2ndBPFMetaData {
		SN_NODE_ID("Salen2ndBPF");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using Salen2ndBPF = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _Salen2ndBPF, Salen2ndBPFMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
