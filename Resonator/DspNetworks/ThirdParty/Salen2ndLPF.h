...
#include "src/Salen2ndLPF.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct Salen2ndLPFMetaData {
		SN_NODE_ID("Salen2ndLPF");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using Salen2ndLPF = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _Salen2ndLPF, Salen2ndLPFMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
