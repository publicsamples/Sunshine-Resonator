...
#include "src/Salen2ndHPF.cpp"
#if (FAUST_INPUTS - FAUST_OUTPUTS) > 0
#error Number of inputs and outputs in faust code must match!
#endif
namespace project {
struct Salen2ndHPFMetaData {
		SN_NODE_ID("Salen2ndHPF");
};
template <int NV, class ModParameterClass=scriptnode::parameter::empty_list>
using Salen2ndHPF = scriptnode::faust::faust_static_wrapper<NV, ModParameterClass, _Salen2ndHPF, Salen2ndHPFMetaData, FAUST_OUTPUTS>;
} // namespace project
 // undef dummy macros
